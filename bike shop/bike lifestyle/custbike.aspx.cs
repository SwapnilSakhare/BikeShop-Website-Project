...
public partial class custbike : System.Web.UI.Page
{
    String p1, p2, p3, p4, p5, p6, p7, p8;
    protected void Page_Load(object sender, EventArgs e)
    {http://localhost:51385/custbike.aspx.cs
        if(Session["logid"]==null)
        {
        Response.Redirect("home.aspx");
        }
        pamount.Text = Session["pramnt"].ToString().Trim();
        pid.Text = Request.QueryString["bkid".ToString()];
    ...
    {
        p2 = Request.QueryString["bkid".ToString()];
    ...
    private void submitupdatedetails()
    {
        ...
        try
        {
            ...
            //command 2
            string sqlquery = "update biketbl set bquantity='" + qn + "' where bid='" + p2 + "' ";
            SqlCommand cmd1 = new SqlCommand(sqlquery, sqlcon);
